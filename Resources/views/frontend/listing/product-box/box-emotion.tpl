...
{block name='frontend_listing_box_article_image_picture'}
    ...
    {if $sArticle.image.thumbnails}
        ...
        <picture>
            ...
            <img data-src="{$sArticle.image.thumbnails[0].source}" alt="{$desc|strip_tags|truncate:160}" class="lazyload" />
        </picture>

    {elseif $sArticle.image.source}
        <img data-src="{$sArticle.image.source}" alt="{$desc|strip_tags|truncate:160}" class="lazyload" />
    {else}
        <img data-src="{link file='frontend/_public/src/img/no-picture.jpg'}" alt="{$desc|strip_tags|truncate:160}" class="lazyload" />
    {/if}
{/block}